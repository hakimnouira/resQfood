package controllers.hakim;/* SPDX-License-Identifier: MIT */
...
public final class SearchController extends OutlinePage {
...
//op.getChildren().add(fn_wa());
       // op.getStylesheets().add(getClass().getResource("D:\\Downloads\\SampleApp-CRUD-Java-master\\PIDEV_project\\lib\\atlantafx-base-2.0.1.jar!\\atlantafx\\base\\theme\\cupertino-dark.css").toExternalForm());

    }
@FXML
public VBox op;
    public Button fn_wa( Scene A){
    ...
    public ExampleBox notificationDialogExample() {
        //snippet_1:start
        System.out.println("awtech");
        var infoBtn = new Button("Info", new FontIcon(Feather.INFO));
        infoBtn.setOnAction(e -> {
            var alert = new Alert(AlertType.INFORMATION);
            alert.setTitle("Information Dialog");
