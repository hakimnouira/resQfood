package controllers.hakim.atlantafx;/* SPDX-License-Identifier: MIT */
...
private static final Heading TOP = new Heading("Top", new Text());
    public ModalPanePage(int i) {
       super();
       this.getStyleClass().remove("outline-page");
        this.userContent.getStyleClass().remove("user-content");
        this.getChildren().removeAll();
        this.userContent.getChildren().removeAll();
        this.outline.getChildren().removeAll();



      //  this.addPageHeader();
      // this.userContent.getChildren().remove();
...
*/
        ...
        addSection("", contentPositionExample1());

     //   getChildren().add(contentPositionExample1());
    ...
    public ExampleBox contentPositionExample() {
        //snippet_2:start
        ...
        var box = new HBox(HGAP_20, openTopBtn);
        box.setAlignment(Pos.CENTER);
    ...
    public HBox contentPositionExample1() {
        //snippet_2:start
        var topDialog = new Dialog(-1, 150);
    ...
    public static class Dialog extends VBox {
        ...
        public Dialog(int width, int height) {
            ...
            setStyle("-fx-background-color: -color-bg-red;");
        }
    }
